---
title: shieldGroq()
description: Groq provider wrapper with automatic prompt hardening, injection detection, and leak sanitization
---
...
<ParamField path="client" type="Groq" required>
  An instance of the Groq SDK client (from `groq-sdk` package >= 0.3.0)
</ParamField>

<ParamField path="options" type="ShieldGroqOptions">
